...
tags:
    ...
    - SSG
    - JavaScript
thumbnail: /assets/img/en.jpg
---
Vaihteeksi ensimmäinen blogikirjoitus ;)

Olen pyöritellyt parisen viikkoa Githubissa jo useampaakin Eleventy-projektia ja nyt aloitin taas alusta. Nyt käytän Eleventyssä Elva-nimistä aloitusteemaa. Tämä projektien pystyyn laittaminen, konfigurointi, deletointi ym. toimet uudestaan ja uudestaan ovat mainio matka itselleni uusien asioiden oppimisessa. Toisto tuo varmuutta asioihin. 

Mikä on Eleventy ts. uudelta nimeltään Build Awesome? Lyhyesti: järjestelmä, jolla generoidaan staattisia webbisivuja. Luepa siitä: [https://www.11ty.dev/](https://www.11ty.dev/)

### Elva - mainio aloitusteema Eleventyyn ###

Elva löytyy Eleventyn sivuilta monien aloitusprojektien joukosta. Jokin siinä heti tuntui hyvältä, kun selailin eri vaihtoehtoja, oli hyvä intuitio. Nyt kun olen sen kanssa testaillut, niin olen vakuuttunut siitä, että tämä voi kehittyä vielä erinomaiseksi. Siis, tämähän pyörii Eleventyn 4 alpha-version päällä, virallinen tuotannossa oleva versio taitaa olla 3.1.6 tms. On "bleeding edge", vähän samaan tapaan kuin "kotisomessani" [Mementomori.social](https://mementomori.social){:target="_blank"}:issa.

Minua viehätti jotenkin Elvan designin yksinkertaisuus ja sen harmonisuus. Kun tutustuin tarkemmin tekijän ajatuksiin, huomasin allekirjoittavani monen asian itsekin. 

[Elva - A multilingual, clean, green 11ty starter theme. ](https://scott.ee/project/elva/) 

Vaikka aikoinaan olin webmasterina ja opetin frontend-juttuja mm. Tieturilla, niin paljon on uusia juttuja tullut sen jälkeen. Kehitys kehittyy. Elvassa CSS on uskomattoman hienon konseptin takana. Kun olen lukenut ja hieman perehtynyt siihen, niin täytyy sanoa, olen aivan pähkinöinä. Kyllä tuo responsiivisuus on ottanut askeleita siitä, kun viimeksi CSS-kurssin olen pitänyt.

[https://utopia.fyi/](https://utopia.fyi/)

### WordPress vs. SSG - aka Static Site Generators ###

Tämä on se juttu, joka minut ensi vaiheessa sai aloittamaan uudelleen opiskelun. Olen jollain tapaa kyllästynyt ylläpitämään WordPress-sivustoa monestakin syystä. 
Tässä muutama syy:
- Aina saa olla päivittämässä ohjelmistoa ja lisäosia, liian usein
- Edelliseen liittyen, tietoturva
- Suuri osa sisällöstäni on simppeliä tekstiä ja kuvia, se hoituisi aivan perus HTML:llä
- Ei tuo WordPress-sivustoni kovin hidas ole, mutta perus HTML-sivut ovat rakettinopeita
...
Nämä ovat ehkä päällimmäisinä uusina asioina minulle.

Hei, mutta **oppia ikä kaikki!**