...
Olen pyöritellyt parisen viikoa Githubissa jo useampaa Eleventy-projektia ja aloitin taas alusta. Nyt käytän Eleventyssä Elva-nimistä aloitusteemaa. Tämä projektien pystyyn laittaminen, konfigurointi, deletointi ym. toimet uudestaan ja uudestaan ovat mainio matka itselleni uusien asioiden oppimisessa. Toisto tuo varmuutta asioihin. 

Mikä on Eleventy ts. uudelta nimeltään Build Awesome? Luepa siitä: [https://www.11ty.dev/](https://www.11ty.dev/)
...
- Suuri osa sisällöstä on simppeliä tekstiä, se hoituisi perus HTML:llä
- Ei WordPress-sivustoni kovin hidas ole, mutta perus HTML-sivut ovat rakettinopeita

En missään nimessä halua mollata WordPressiä, olenhan sen parissa viihtynyt 20+ vuotta. Olen ohjelmiston ansiosta tienannut perheelleni toimeentuloa, sillä olihan WordPress-kurssit minulla koulutusrepertuaarissani. Niitä kursseja tuli pidettyä muutamia kymmeniä niitäkin, ja muutamalle asiakkaalle olen rakentanut ja ylläpitänyt kokonaisia sivustoja. Olen myös ottanut yhteisön toimintaan hieman osaa mm. muutamaan WordCamppiin vapaaehtoistyöntekijänä. Olen myös suomentaja muutamalle teemalle/lisäosalle. Mukavaa on ollut.
...
Nämä ehkä päällimmäisinä uusina asioina minulle.
